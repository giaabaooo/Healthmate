...
const FitnessGoal = () => {
  ...
  const fetchGoalData = async () => {
    ...
    try {
      ...
      if (goalData && goalData._id) {
        ...
        const res = await fetch(`https://healthmate.onrender.com/api/goals/micro/${goalData._id}`, {
  ...
  const handleGenerateAIRoadmap = async () => {
      ...
      try {
          const res = await fetch(`https://healthmate.onrender.com/api/goals/generate-roadmap`, {
              method: "POST",
              headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  const handleFetchHistory = async () => {
    try {
        const token = localStorage.getItem("token");
        const res = await fetch(`https://healthmate.onrender.com/api/goals/history`, {
            headers: { Authorization: `Bearer ${token}` }
        });
        if (res.ok) {
            const data = await res.json();
  ...
  const toggleMicroGoal = async (id: string, currentStatus: boolean) => {
    ...
    try {
        const token = localStorage.getItem("token");
        await fetch(`https://healthmate.onrender.com/api/goals/micro/${id}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  const saveEditTask = async (id: string) => {
    ...
    try {
        const token = localStorage.getItem("token");
        const res = await fetch(`https://healthmate.onrender.com/api/goals/micro/${id}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  const submitCheckin = async () => {
      ...
      try {
          ...
          const res = await fetch(`https://healthmate.onrender.com/api/goals/checkin/${goal._id}`, {
              method: "POST",
              headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
