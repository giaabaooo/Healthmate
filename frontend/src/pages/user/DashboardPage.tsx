...
const DashboardPage: React.FC = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const statsResponse = await fetch('https://healthmate.onrender.com/api/tracker/dashboard-stats', {
        headers: {
      ...
      const bodyResponse = await fetch('https://healthmate.onrender.com/api/tracker/body-progress?period=month', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
      ...
      const workoutResponse = await fetch('https://healthmate.onrender.com/api/tracker/workouts?period=week', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
