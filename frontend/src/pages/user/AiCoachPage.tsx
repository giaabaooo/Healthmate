...
const AiCoachPage = () => {
  // --- STATE & LOGIC BẢO LƯU TỪ CODE CŨ ---
  ...
  // Ref dùng để tự động cuộn chat xuống dưới cùng
  ...
  return (
    <Layout>
      {/* Background Elements (Futuristic Aesthetic) */}
      ...
      <div className="p-4 md:p-8 grid grid-cols-12 gap-6">
        
        {/* --- Header Section --- */}
        <header className="col-span-12 flex justify-between items-center mb-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">
              Health Analytics <span className="text-primary">& AI Coach</span>
            </h1>
            <p className="text-slate-500 dark:text-slate-400">Deep biological insights powered by HealthMate AI</p>
          </div>
        ...
        {/* --- CỘT TRÁI: Health Metrics & Body Impact --- */}
        <div className="col-span-12 lg:col-span-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
              ...
              <div className="text-3xl font-bold text-slate-900 dark:text-white">2,140 <span className="text-sm font-normal text-slate-400">kcal</span></div>
              <div className="mt-2 text-xs text-primary flex items-center">
                <span className="material-icons text-xs mr-1">trending_up</span> 12% vs last week
              </div>
            </div>
            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
              <div className="flex justify-between items-start mb-4">
              ...
              <div className="text-3xl font-bold text-slate-900 dark:text-white">88<span className="text-sm font-normal text-slate-400">%</span></div>
              <div className="mt-2 text-xs text-primary flex items-center">
                Optimal State
              </div>
            </div>
            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
              ...
              <div className="text-3xl font-bold text-slate-900 dark:text-white">7h 42m</div>
              <div className="mt-2 text-xs text-amber-500 flex items-center">
                <span className="material-icons text-xs mr-1">warning</span> Light REM deficit
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-8 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-xl font-bold text-slate-900 dark:text-white">Workout Impact Analysis</h2>
              <div className="flex gap-2">
                <button className="px-3 py-1 text-xs font-semibold rounded bg-primary/20 text-primary border border-primary/30">7D</button>
                <button className="px-3 py-1 text-xs font-semibold rounded text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">30D</button>
              </div>
            </div>
            <div className="h-64 relative flex items-end justify-between gap-2 px-4">
              <div className="w-full bg-slate-100 dark:bg-slate-800 rounded-t-lg relative group overflow-hidden" style={{ height: '60%' }}>
                <div className="absolute bottom-0 w-full bg-primary/40 group-hover:bg-primary transition-all h-full"></div>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 rounded-t-lg relative group overflow-hidden" style={{ height: '45%' }}>
                <div className="absolute bottom-0 w-full bg-primary/40 group-hover:bg-primary transition-all h-full"></div>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 rounded-t-lg relative group overflow-hidden" style={{ height: '85%' }}>
                <div className="absolute bottom-0 w-full bg-primary/40 group-hover:bg-primary transition-all h-full"></div>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 rounded-t-lg relative group overflow-hidden" style={{ height: '30%' }}>
                <div className="absolute bottom-0 w-full bg-primary/40 group-hover:bg-primary transition-all h-full"></div>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 rounded-t-lg relative group overflow-hidden" style={{ height: '95%' }}>
                <div className="absolute bottom-0 w-full bg-primary/40 group-hover:bg-primary transition-all h-full"></div>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 rounded-t-lg relative group overflow-hidden" style={{ height: '70%' }}>
                <div className="absolute bottom-0 w-full bg-primary/40 group-hover:bg-primary transition-all h-full"></div>
              </div>
              <div className="w-full bg-slate-100 dark:bg-slate-800 rounded-t-lg relative group overflow-hidden" style={{ height: '55%' }}>
                <div className="absolute bottom-0 w-full bg-primary/40 group-hover:bg-primary transition-all h-full"></div>
              </div>
            </div>
          ...
          {/* Injury Risk & Performance Insights */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
              ...
              <div className="relative flex flex-col items-center">
                <div className="w-48 h-24 overflow-hidden relative">
                  ...
                  <div className="absolute top-0 w-48 h-48 rounded-full border-[12px] border-transparent border-l-primary border-t-primary rotate-[15deg]"></div>
                </div>
                <div className="absolute top-16 text-center">
                  <span className="text-2xl font-bold text-slate-900 dark:text-white">Low</span>
                  <p className="text-[10px] text-slate-400 uppercase">Current Risk Level</p>
                </div>
              </div>
              <p className="text-sm text-slate-600 dark:text-slate-400 mt-4 leading-relaxed text-center">
                Your joints and muscles show minimal fatigue. It is safe to proceed with high-intensity compound movements today.
              </p>
            </div>
            ...
            <div className="bg-primary/5 dark:bg-primary/10 p-6 rounded-xl border border-primary/20 shadow-sm">
              ...
              <p className="text-sm font-medium mb-3 text-slate-900 dark:text-white">Optimize Strength Gains:</p>
              <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-300">
                <li className="flex gap-2">
                  <span className="material-icons text-xs text-primary mt-0.5">check_circle</span>
                  Increase protein intake by 20g today based on yesterday's eccentric load.
                </li>
                <li className="flex gap-2">
                  <span className="material-icons text-xs text-primary mt-0.5">check_circle</span>
                  Leg day is recommended. Your lower-body nervous system recovery is at 94%.
                </li>
                <li className="flex gap-2">
                  <span className="material-icons text-xs text-primary mt-0.5">check_circle</span>
                  Shift HIIT session to tomorrow for peak cardiovascular efficiency.
                </li>
              </ul>
            </div>
          </div>
        ...
        {/* --- CỘT PHẢI: AI Coach Chatbot --- */}
        <div className="col-span-12 lg:col-span-4 h-[600px] lg:h-[calc(100vh-140px)]">
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-xl flex flex-col h-full sticky top-8 overflow-hidden">
            ...
            <div className="p-4 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shrink-0">
              <div className="flex items-center gap-2 mb-3 overflow-x-auto pb-1 hide-scrollbar">
                <button 
                  onClick={() => setInput("Adjust my macros for today")}
                  className="whitespace-nowrap px-3 py-1 bg-slate-100 dark:bg-slate-800 text-[10px] font-bold rounded-full text-slate-500 hover:text-primary transition-colors">
                  Adjust macros
                </button>
                <button 
                  onClick={() => setInput("Show my current progress")}
                  className="whitespace-nowrap px-3 py-1 bg-slate-100 dark:bg-slate-800 text-[10px] font-bold rounded-full text-slate-500 hover:text-primary transition-colors">
                  Show my progress
                </button>
              </div>
              ...
              <div className="relative flex gap-2">
                ...
                <button 
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-primary text-slate-900 rounded-lg flex items-center justify-center hover:scale-105 transition-transform disabled:opacity-50 disabled:hover:scale-100"
                >
