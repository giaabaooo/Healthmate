...
**Endpoint:** `POST https://healthmate.onrender.com/api/tracker/workouts`

**Test với Postman/curl:**
```bash
curl -X POST https://healthmate.onrender.com/api/tracker/workouts \
...
**Endpoint:** `GET https://healthmate.onrender.com/api/tracker/workouts?period=week&limit=10`

**Test:**
```bash
curl -X GET "https://healthmate.onrender.com/api/tracker/workouts?period=week&limit=10" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
**Endpoint:** `POST https://healthmate.onrender.com/api/tracker/body-progress`

**Test:**
```bash
curl -X POST https://healthmate.onrender.com/api/tracker/body-progress \
  -H "Authorization: Bearer YOUR_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "weight_kg": 75.5,
...
**Endpoint:** `GET https://healthmate.onrender.com/api/tracker/body-progress?period=month`
...
**Endpoint:** `GET https://healthmate.onrender.com/api/tracker/dashboard-stats`
...
const createTestData = async () => {
  ...
  for (let i = 0; i < weightData.length; i++) {
    ...
    await fetch('https://healthmate.onrender.com/api/tracker/body-progress', {
      method: 'POST',
      headers: {
  ...
  for (let i = 0; i < workouts.length; i++) {
    ...
    await fetch('https://healthmate.onrender.com/api/tracker/workouts', {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json'
...
// Test API directly
fetch('https://healthmate.onrender.com/api/tracker/dashboard-stats', {
...
### Network Tab
- Check API requests to `https://healthmate.onrender.com/api/tracker/*`
