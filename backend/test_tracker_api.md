...
### Login để lấy token
```http
POST https://healthmate.onrender.com/api/users/login
...
```http
POST https://healthmate.onrender.com/api/tracker/workouts
...
```http
GET https://healthmate.onrender.com/api/tracker/workouts?period=week&limit=10
Authorization: Bearer YOUR_TOKEN_HERE
```

### 3.3 Cập nhật chỉ số cơ thể
```http
POST https://healthmate.onrender.com/api/tracker/body-progress
Authorization: Bearer YOUR_TOKEN_HERE
Content-Type: application/json
...
```http
GET https://healthmate.onrender.com/api/tracker/body-progress?period=month
Authorization: Bearer YOUR_TOKEN_HERE
```

### 3.5 Lấy thống kê dashboard
```http
GET https://healthmate.onrender.com/api/tracker/dashboard-stats
Authorization: Bearer YOUR_TOKEN_HERE
```
...
### Test login
```bash
curl -X POST https://healthmate.onrender.com/api/users/login \
